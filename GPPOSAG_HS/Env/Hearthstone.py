...
clr.AddReference(os.getcwd() + "/Env/DllSimulator/SabberStoneCore.dll")
clr.AddReference(os.getcwd() + "/Env/DllSimulator/SabberStoneBasicAI.dll")
...
from Env.utils import modify_cards, DeckList, check_race, check_type
import logging
...
class Hearthstone:
    def __init__(self, random_cards=False, player1_name="Player1", player2_name="Player2", start_player=1,
                 ...
                 player1_deck=None, player2_deck=None, vs_StoneZero=True):
        ...
        self.if_vs_StoneZero = vs_StoneZero
    ...
    def player_state(self, current = True):
        ...
        """
        if self.if_vs_StoneZero:
            if self.game.CurrentPlayer.Name == "Player1":
                hero_state = np.zeros((2, 29))
            else:
    ...
    def get_model_input(self, game_state):
        ...
        if self.if_vs_StoneZero and self.game.CurrentPlayer.Name == "Player2":
