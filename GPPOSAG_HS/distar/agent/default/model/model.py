...
class Model(nn.Module):
    def __init__(self, cfg={}, use_value_network=False, temperature=None):
        ...
        # for name, param in self.core_lstm.named_parameters():
        #     param.requires_grad = False

    def forward(self, hand_card: Tensor, entity_info: Tensor, scalar_info: Dict[str, Tensor],
        ...
        lstm_input, scalar_context, baseline_feature, entity_embeddings, map_skip = \
            self.encoder(hand_card, entity_info, scalar_info, entity_num)
