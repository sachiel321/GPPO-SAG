...
def get_args():
    ...
    parser.add_argument('--model1', type=str,
                        default='/home/ymyang/yangyiming/DI-star-main/experiments/sl_train/checkpoint/sl_train_iteration_99000',
    ...
    parser.add_argument('--game_type', type=str, default='agent_vs_bot')
...
if __name__ == '__main__':
    ...
    if args.model1 is not None:
        model1 = os.path.join(os.path.join(os.path.dirname(__file__), args.model1 + '.pth.tar'))
    ...
    if args.model2 is not None and 'bot' not in args.model2:
